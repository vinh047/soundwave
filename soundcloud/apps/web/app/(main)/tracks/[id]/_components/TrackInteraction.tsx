  ...
  const actions = [
    {
      ...
      color: isLiked ? "text-[#ff5500] border-[#ff5500]" : "hover:text-[#ff5500] hover:border-[#ff5500]",
      onClick: handleLike,
      fill: isLiked,
    },
    {
      ...
      color: isReposted ? "text-[#00ff00] border-[#00ff00]" : "hover:text-[#00ff00] hover:border-[#00ff00]",
    ...
    { icon: Share2, label: "Share", color: "hover:text-white", onClick: () => { }, fill: false },
    { icon: MoreVertical, label: "", color: "hover:text-white", onClick: () => { }, fill: false },
  ];
            ...
            <div key={comment.id} className="flex gap-3 group">
              ...
              <div className="flex-1">
                <div className="flex items-baseline gap-2">
                  <Link href={`/profile/${comment.user.id}`} className="text-sm font-semibold text-gray-800 dark:text-white hover:underline">
