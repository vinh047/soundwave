...
export default function ReportsPage() {
  ...
  return (
    <div className="space-y-6 relative">
      ...
      {toast && (
        <div className={`fixed bottom-5 right-5 z-50 flex items-center gap-3 px-4 py-3 rounded-lg shadow-lg animate-in slide-in-from-bottom-5 ${toast.type === 'success' ? 'bg-emerald-600 text-white' : 'bg-red-600 text-white'
          }`}>
              ...
              {report.status === "pending" && (
                <div className="flex flex-col gap-2 min-w-[170px]">
                  <Button
                    ...
                    light
                    className="w-full justify-start text-xs bg-zinc-800 hover:bg-zinc-700 text-zinc-300 border border-zinc-700 transition-all"
                  >
                  ...
                  {report.targetType === 'User' ? (
                    <Button
                      ...
                      light
                      className="w-full justify-start text-xs bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white border-none shadow-lg shadow-orange-500/20 transition-all"
                    >
                    ...
                    <Button
                      ...
                      dark
                      className="w-full justify-start text-xs bg-gradient-to-r from-red-500 to-rose-500 hover:from-red-600 hover:to-rose-600 text-white border-none shadow-lg shadow-red-500/20 transition-all"
                    >
