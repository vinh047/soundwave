...
type SliderProps = Omit<React.ComponentProps<typeof SliderPrimitive.Root>, "value" | "onValueChange" | "className"> &
  SliderCustomProps;

export const Slider = ({ value = 0, onValueChange, className, ...props }: SliderProps) => {
  return (
    <SliderPrimitive.Root
      {...props}
      value={[value]} // convert number -> array
      onValueChange={(val) => onValueChange?.(val[0])} // array -> number
